...
# 📝 My recent status:
Learning swiftUI and Use ChatGPT to help me coding. Also try use Stable diffusion to draw some beautiful anime girl <br>

In school: Leaning JSP and SAP (It is old, but still feel fun), and the test is annoying. <br>

And also: doing final year project using swift, it includes webRTC, ARkit, roomPlan ...etc.
